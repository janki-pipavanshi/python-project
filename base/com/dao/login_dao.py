...
class LoginDAO:
    ...
    def find_login_id(self, login_vo):
        login_vo_list = LoginVO.query.filter_by(login_username=login_vo.login_username).first()
        login_id = login_vo_list.login_id
        return login_id
    ...
    def find_login_password(self, login_vo):
        login_vo_list = LoginVO.query.filter_by(login_username=login_vo.login_username).all()
        login_password = login_vo_list[0].login_password
