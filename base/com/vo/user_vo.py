...
class UserVO(db.Model):
    ...
    user_date_of_birth = db.Column('user_date_of_birth', db.Date, nullable=False)
    user_contact = db.Column('user_contact', db.String(10), nullable=False)
    user_blood_group = db.Column('user_blood_group', db.String(100), nullable=False)
